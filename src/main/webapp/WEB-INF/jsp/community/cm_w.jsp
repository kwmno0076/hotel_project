...
<meta charset="UTF-8">
<title>게시판</title>
<link rel="stylesheet" type="text/css" href="./css/cm_w.css" /><%-- css적용 --%>
...
<div id="container_cm"><%-- 헤더아래 배경 --%>
 ...
 <div id="container_cm2">
  <table id="table" >
   <tr>
    <th class="th1">no</th> <th class="th2" colspan="5">제목</th>
   </tr>
   <tr>
    <td class="td1">1</td> <td colspan="5" class="td1">제목입니다</td>
   </tr>
   <tr>
    <th>작성자</th> <td class="td1">작성자</td>
    <th>작성일</th> <td class="td1">2017.2.28</td>
    <th>조횟수</th> <td class="td1">1</td>
   </tr>
   <tr>
    <th colspan="6">내용</th>
   </tr>
   <tr>
    <td class="td2" colspan="6">
     <textarea cols="80" rows="40">asdfasdfasdfasdfasdf</textarea>
    </td>
   </tr>
  </table>
  
  <%-- 댓글달기 부분 --%>
  <table id="commentTable" class="table-condensed" ></table>
