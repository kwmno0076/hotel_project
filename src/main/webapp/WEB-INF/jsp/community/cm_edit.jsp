...
<div id="container_cm"><%-- 헤더아래 배경 --%>
 ...
 <form method="post" id="asdf" action="cm_edit_ok.kkc" onsubmit="return cm_check();" >
 ...
 <div id="table_div">
  <table id="notice">
   ...
   <tr>
    ...
    <td><input type="password" name="cm_pwd" id="cm_pwd" size="80" class="td1" /></td>
   </tr>
   <tr>
    <th class="th1">제목</th>
    <td><input name="cm_title" id="cm_title" size="80" class="td1" value="${c.cm_title}"/></td>
   </tr>
   <tr>
    <th class="th1">내용</th>
    <td><textarea name="cm_cont" id="cm_cont" rows="30" cols="80" class="td2">${c.cm_cont}</textarea></td>
   </tr>
   <tr>
    <th colspan="2">
