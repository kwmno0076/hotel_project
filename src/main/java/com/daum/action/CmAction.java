...
import com.daum.service.CmService;
...
public class CmAction {
	...
	public ModelAndView cm_write_ok(@ModelAttribute CmBean c){
	...
	public ModelAndView cm_cont(@RequestParam("no") int cm_no, @RequestParam("state") String state,HttpServletRequest request){
		int page=1;
		...
		CmBean c=this.cmService.getCmCont(cm_no);
