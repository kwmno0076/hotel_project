...
<article id="wel_cont">
	<div id="bWrite_wrap">
		...
		<form method="post" action="h_edit_ok.kkc"
 ...
 --%>
			...
			<table id="bw_t">
				...
				<tr>
					<th>방 이름</th>
					<td><input name="h_room" id="h_room" size="14" value="${h.h_room}" /> <%-- type="text"가 생략되면 기본값이 text이다. --%>
						방 가격 <input name="h_price_room" id="h_price_room" size="14" value="${h.h_price_room}" /> <%-- type="text"가 생략되면 기본값이 text이다. --%>
					</td>
				...
				<tr>
					<th>은행 명</th>
					<td><input name="h_bank" id="h_bank" size="14" value="${h.h_bank}"  /> <%-- type="text"가 생략되면 기본값이 text이다. --%>
						계좌번호 <input name="h_anumber" id="h_anumber" size="14"  value="${h.h_anumber} }"/> <%-- type="text"가 생략되면 기본값이 text이다. --%>
					</td>
